    ...
    public function listar()
    {
        ...
        for ($i = 0; $i < count($data); $i++) {
            ...
            if ($data[$i]['estado'] == 1) {
                ...
                $data[$i]['acciones'] = '<button class="btn btn-primary btn-sm" onclick="btnEditarPer(' . $id . ')"><i class="fa fa-pencil-square-o"></i></button> <button class="btn btn-danger btn-sm" onclick="btnEliminarPer(' . $id . ')"><i class="fa fa-trash-o"></i></button>';
            } else {
                $data[$i]['estado'] = '<span class="badge badge-danger">Inactivo</span>';
                $data[$i]['acciones'] = '<button class="btn btn-success btn-sm" onclick="btnReingresarPer(' . $id . ')"><i class="fa fa-reply-all"></i></button>';
            }
        }
