...
<div class="app-title">
    <div>
        <h1><i class="fa fa-dashboard"></i> Lectores Externos</h1>
    </div>
</div>
<button class="btn btn-primary mb-2" type="button" onclick="frmPersonas()"><i class="fa fa-plus"></i></button>
<div class="row">
    <div class="col-lg-12">
        <div class="tile">
            <div class="tile-body">
                <div class="table-responsive">
                    <table class="table table-light mt-4" id="tblPersonas">
...
<div id="nuevoPersonas" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="my-modal-title" aria-hidden="true">
            ...
            <div class="modal-body">
                <form id="frmPersonas">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <button class="btn btn-primary" type="submit" onclick="registrarPersonas(event)" id="btnAccion">Registrar</button>
