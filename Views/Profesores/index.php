...
<div class="app-title">
    <div>
        <h1><i class="fa fa-dashboard"></i> Profesores</h1>
    </div>
</div>
<button class="btn btn-primary mb-2" type="button" onclick="frmProfesores()"><i class="fa fa-plus"></i></button>
<div class="row">
    <div class="col-lg-12">
        <div class="tile">
            <div class="tile-body">
                <div class="table-responsive">
                    <table class="table table-light mt-4" id="tblProfesores">
...
<div id="nuevoProfesores" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="my-modal-title" aria-hidden="true">
            ...
            <div class="modal-body">
                <form id="frmProfesores">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <button class="btn btn-primary" type="submit" onclick="registrarProfesores(event)" id="btnAccion">Registrar</button>
